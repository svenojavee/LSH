...
do 
for P in 0.25 # 0.5 0.75 0.9 0.95 1 #1.25 1.5 2 4 
do 
for n in {1..100}
do
...
cmd=\"python /nfs/scistore13/robingrp/sojavee/S-PCGC/pcgc_sumstats_creator.py --bfile /mnt/beegfs/robingrp/sojavee/LSHResults/simM10k_N20k --pheno /mnt/beegfs/robingrp/sojavee/LSHResults/s${n}_M10k_N20k_h${h2}_K${K}_P${P}.phen --prev $K --out /mnt/beegfs/robingrp/sojavee/LSHResults/sumStatsPCGC/s${n}_M10k_N20k_h${h2}_K${K}_P${P} \"
