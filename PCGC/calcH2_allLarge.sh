...
cmd=\"python /nfs/scistore13/robingrp/sojavee/S-PCGC/pcgc_main.py --sumstats /mnt/beegfs/robingrp/sojavee/LSHResults/sumStatsPCGC/s${n}_M10k_N20k_h${h2}_K${K}_P${P}. --prodr2 /mnt/beegfs/robingrp/sojavee/LSHResults/sumStatsPCGC/simM10k_N20k_NT90k. --M 10000 --out /mnt/beegfs/robingrp/sojavee/LSHResults/sumStatsPCGC/s${n}_M10k_N20k_h${h2}_K${K}_P${P} \"
